...
def checkout_base_files(base_ref='origin/gh-pages', target_dir='/tmp/base-files'):
    ...
    - First PR to a new repository (gh-pages branch doesn't exist yet)
    - Repository doesn't use gh-pages for deployment
    - Network/permissions issues accessing the remote branch
